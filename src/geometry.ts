...
export class TriangleC extends Triangle {
  ...
  split(): Triangle[] {
    const vector_12 = Vector.fromPoints(this.v1, this.v2).multiply(
      GOLDEN_RATIO
    );
    ...
    new_triangles.push(
      new TriangleC(this.v3, split_point_12, this.v2, 'C' + this.coord)
    );
    new_triangles.push(
      new TriangleY(split_point_12, this.v3, this.v1, 'Y' + this.coord)
    );
...
export class TriangleD extends Triangle {
  ...
  split(): Triangle[] {
    const vector_13 = Vector.fromPoints(this.v1, this.v3).multiply(
      GOLDEN_RATIO
    );
    ...
    const new_triangles: Triangle[] = [];
    new_triangles.push(
      new TriangleD(this.v2, this.v3, split_point_13, 'D' + this.coord)
    );
    new_triangles.push(
      new TriangleX(split_point_13, this.v1, this.v2, 'X' + this.coord)
    );
...
export class TriangleX extends Triangle {
  ...
  split(): Triangle[] {
    const vector_32 = Vector.fromPoints(this.v3, this.v2).multiply(
      GOLDEN_RATIO
    );
    const split_point_32 = this.v3.add(vector_32);

    const vector_31 = Vector.fromPoints(this.v3, this.v1).multiply(
      GOLDEN_RATIO
    );
    ...
    const new_triangles: Triangle[] = [];
    new_triangles.push(
      new TriangleY(split_point_31, split_point_32, this.v3, 'Y' + this.coord)
    );
    new_triangles.push(
      new TriangleC(split_point_32, split_point_31, this.v1, 'C' + this.coord)
    );
    new_triangles.push(
      new TriangleX(split_point_32, this.v1, this.v2, 'X' + this.coord)
    );
...
export class TriangleY extends Triangle {
  ...
  split(): Triangle[] {
    const vector_21 = Vector.fromPoints(this.v2, this.v1).multiply(
      GOLDEN_RATIO
    );
    const split_point_21 = this.v2.add(vector_21);

    const vector_23 = Vector.fromPoints(this.v2, this.v3).multiply(
      GOLDEN_RATIO
    );
    ...
    const new_triangles: Triangle[] = [];
    new_triangles.push(
      new TriangleY(split_point_23, this.v3, this.v1, 'Y' + this.coord)
    );
    new_triangles.push(
      new TriangleD(split_point_23, this.v1, split_point_21, 'D' + this.coord)
    );
    new_triangles.push(
      new TriangleX(split_point_21, this.v2, split_point_23, 'X' + this.coord)
    );
...
export const triangleListsIntersect = function (
  As: Triangle[],
  Bs: Triangle[]
): boolean {
